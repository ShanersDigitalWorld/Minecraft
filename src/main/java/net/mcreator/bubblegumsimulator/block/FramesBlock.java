...
public class FramesBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:frames")
	public static final Block block = null;
	public FramesBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 5);
	}
