...
public class GrassBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:grass")
	public static final Block block = null;
	public GrassBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 2);
	}
