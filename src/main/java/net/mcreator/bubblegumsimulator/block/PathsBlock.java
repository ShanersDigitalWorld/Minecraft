...
public class PathsBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:paths")
	public static final Block block = null;
	public PathsBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 6);
	}
