...
public class PortalBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:portal")
	public static final Block block = null;
	public PortalBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 4);
	}
