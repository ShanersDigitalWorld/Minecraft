...
public class TopsBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:tops")
	public static final Block block = null;
	public TopsBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 3);
	}
