...
public class Trampoline2Block extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:trampoline_2")
	public static final Block block = null;
	public Trampoline2Block(BubbleGumSimulatorModElements instance) {
		super(instance, 11);
	}
