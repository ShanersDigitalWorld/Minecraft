...
public class TrampolineBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:trampoline")
	public static final Block block = null;
	public TrampolineBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 10);
	}
