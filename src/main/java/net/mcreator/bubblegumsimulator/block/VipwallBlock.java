...
public class VipwallBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:vipwall")
	public static final Block block = null;
	public VipwallBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 22);
	}
