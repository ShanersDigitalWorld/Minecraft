...
public class WaterBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:water")
	public static final Block block = null;
	public WaterBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 9);
	}
